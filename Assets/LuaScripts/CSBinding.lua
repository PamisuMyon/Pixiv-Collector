...
-------------------------Custom-------------------
---@type PixivCollector.Utils
Utils = CS.PixivCollector.Utils
---@type PixivCollector.NetworkManager
NetworkManager = CS.PixivCollector.NetworkManager
---@type PixivCollector.ImageLoader
ImageLoader = CS.PixivCollector.ImageLoader
---@type PixivCollector.AddressablesManager
AddressablesManager = CS.PixivCollector.AddressablesManager
---@type PixivCollector.LuaManager
LuaManagerr = CS.PixivCollector.LuaManager
-------------------------.NET Namespace-------------------
